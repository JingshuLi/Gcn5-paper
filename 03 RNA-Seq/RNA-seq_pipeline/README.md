...
In manuscript, we used the following commands. 

We first generated the associated STAR index for fly genome. 
...
> Annotation:
>
> - fly: http://ftp.flybase.net/releases/FB2020_05/dmel_r6.36/gtf/dmel-all-r6.36.gtf.gz
...
-i ~/RNApipe/data \
-o ~/RNApipe/results \
--ref /Reference/fly/index/star_index/Dmel6.36/ \
--gtf /Reference/fly/annotation/dmel-all-r6.36.gtf\
-t 32 >nohup1.out 2>&1 &
```
...
If you use `RNAseq_pipeline.sh` for your analysis, please cite the publication: [ONE-seq: epitranscriptome and gene-specific profiling of NAD-capped RNA]()
